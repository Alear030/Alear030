...
这个目录下是我和 coding agent 协作时用的十三个技能，一共 1224 行，全部进了版本控制，可以直接点开看。
...
| [`alear030-pr-review`](alear030-pr-review/SKILL.md) | 148 | 已开 PR 的 merge 前只读审查，由不带会话历史的执行者跑三道对账与对抗式输入审视，加一条退出标准 |
