...
This directory holds the thirteen skills I use when working with coding agents — 1224 lines in total, all under version control, and you can open any of them directly.
...
| [`alear030-pr-review`](alear030-pr-review/SKILL.md) | 148 | Read-only pre-merge review of an open PR, run by an executor with no session history: three reconciliation passes, an adversarial-input pass, and one exit criterion |
