...
@register_tool(tool_name='skill_list',tool_desc=skill_list_desc,tool_prompt=skill_list_prompt,tool_enabled=True,role=['main'])
def skill_list()->list:
    tools_path = Path(Path(__file__).parent).parent
    skill_path = Path(tools_path).parent/'skill'
...
@register_tool(tool_name='skill_load',tool_desc=skill_list_desc,tool_enabled=True,role=['main'])
def skill_load(skill_name:str)->str:
    tool_path = Path(__file__).parent
    skill_path = Path(tool_path).parent/'skill'
