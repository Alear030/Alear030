...
- `$alear030-issue-mark`：按项目标签体系（tech-debt/boundary-violation/eval-require/atomic 等）记录审查或复盘发现的问题。想找能独立修完、不需要项目上下文积累的 issue，用 `gh issue list --repo Alear030/Alear030 --label atomic`。
